...
from BinaryHeap_smallG import MinBinaryHeap_smallG
...
minbinaryheap_open_list = MinBinaryHeap_smallG()
closed_list = []

def main():

    # file output
    outfile = open('RepeatedForwardAstarSmallG_50GridRuns.log','w+')
    print('-----------------------------------------------------------------------------------------', file=outfile)
    print('** Algorithm: Repeated Forward A* (use Small-G to break ties)', file=outfile)
    print('**            ', file=outfile)
